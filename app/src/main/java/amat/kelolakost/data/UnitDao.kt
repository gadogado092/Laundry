...
interface UnitDao {
    ...
    @Query(
        "SELECT Unit.id AS id, Unit.name AS name, Unit.noteMaintenance AS noteMaintenance, Unit.unitStatusId AS unitStatusId, " +
                ...
                "Tenant.id AS tenantId, Tenant.name AS tenantName, Tenant.numberPhone AS tenantNumberPhone, Tenant.limitCheckOut AS limitCheckOut, Tenant.additionalCost AS additionalCost, Tenant.noteAdditionalCost AS noteAdditionalCost, " +
                ...
                "LEFT JOIN (SELECT Tenant.id, Tenant.name, Tenant.numberPhone, Tenant.limitCheckOut, Tenant.additionalCost, Tenant.noteAdditionalCost FROM Tenant) AS Tenant ON Unit.tenantId = Tenant.id " +
