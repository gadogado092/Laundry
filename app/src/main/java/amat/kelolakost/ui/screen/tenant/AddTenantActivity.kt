    ...
    Column {
        ...
        Column(
            ...
            MyOutlinedTextField(
                ...
                value = addTenantViewModel.unitTypeUi.collectAsState().value.name,
                onValueChange = {
            ...
            MyOutlinedTextField(
                ...
                value = addTenantViewModel.unitTypeUi.collectAsState().value.numberPhone,
                onValueChange = {
            ...
            MyOutlinedTextField(
                label = "Alamat Email",
                value = addTenantViewModel.unitTypeUi.collectAsState().value.email,
                onValueChange = {
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Row(modifier = Modifier.fillMaxWidth()) {
                    Row(
                        ...
                        RadioButton(
                            selected = (!addTenantViewModel.unitTypeUi.collectAsState().value.gender),
            ...
            MyOutlinedTextField(
                label = "Alamat",
                keyboardOptions = KeyboardOptions(capitalization = KeyboardCapitalization.Sentences),
                value = addTenantViewModel.unitTypeUi.collectAsState().value.address,
                onValueChange = {
            ...
            MyOutlinedTextField(
                ...
                keyboardOptions = KeyboardOptions(capitalization = KeyboardCapitalization.Sentences),
                value = addTenantViewModel.unitTypeUi.collectAsState().value.note,
                onValueChange = {
