...
class AddCategoryActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaundryAppTheme {
                if (id != null) {
                    AddCategoryScreen(context, id)
                } else {
                    AddCategoryScreen(context, "")
                }
            }
        }
...
fun AddCategoryScreen(
    ...
    val viewModel: AddCategoryViewModel =
        viewModel(
...
@Composable
fun FormCategory(context: Context, viewModel: AddCategoryViewModel) {
    Column(
        modifier = Modifier
            .fillMaxSize()
